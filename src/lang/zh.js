export default {
  route: {
    ...
    registered: '注册',
    commitment: '合法合规承诺',
    institutions: '从业机构业务登记',
    Notificationinformation: '通知资料报送',
    workReporst: '机构信息',
    workReporstNoticesd: '机构信息查询',
    institutionalCheck: '机构审核',
    beforeAppro: '预认证审核',
    registerAppro: '登记认证审核',
    institutionals: '机构信息管理',
    organizationManagement: '机构管理',
    institutional: '机构信息维护',
    details: '机构信息详情',
    modify: '机构信息修改',
    others: '详情页',
    ...
    registerAppros: '登记基础资料',
    institutionalOther: '通知要求报备',
    regulatoryManagement: '监管记录',
    report: '制度报备',
    reportedIndependent: '自主报备',
    systemReport: '制度信息管理',
    noticeReport: '通知要求报备',

    workReport: '工作报告',
    announcements: '通知公告',
    announcementsList: '公告列表',
    workReportAutonomy: '自主报告',
    workReportNotice: '通知要求报告',
    regulatoryMsg: '监管记录',
    userManagement: '用户管理',
    parameter: '参数管理',
    risk: '风险关注',
