<template>
  <el-card class="registerOneRZ">
    <div slot="header" class="header">
      <div style="margin-left:5%">
        <img :src="bgMonitorImg" alt="">
      </div>
    </div>
    <h2 style="width:100%;text-align:center;margin-top:50px">科技公司注册</h2>
    <div class="baseBox">
          ...
          <el-row :gutter="20">
            <el-col :span="24">
              <el-form-item label="公司简介" prop="bussScope">
                <el-input v-model="form.bussScope" type="textarea" :rows="3" placeholder="请输入" />
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="20">
            <el-col :span="24">
              <el-form-item label="资质荣誉" prop="mainNetBuss">
                <el-input v-model="form.mainNetBuss" type="textarea" :rows="3" placeholder="请输入" />
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="公司Logo" prop="fileName2">
                <el-input v-model="form.fileName2" disabled style="width: 100%">
                  <template slot="prepend">
                    <el-button v-show="form.fileName2" type="primary" @click="clearFile2">删除文件<i class="el-icon-delete-solid el-icon--right" /></el-button>
                    <el-upload
                      v-show="!form.fileName2"
                      ref="upload2"
                      :auto-upload="false"
...
export default {
  ...
  computed: {
    ...
    actionUrl2() {
      return `nifa-autonomy-file/upload/upload-attach?noteId=${this.riidNum}&ownSystem=14&ownBusiness=nifaReport`
    },
    actionUrl7() {
