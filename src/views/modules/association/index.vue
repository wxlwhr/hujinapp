<template>
  <el-card class="continue">
    ...
    <el-tabs v-model="activeName" type="card" @tab-click="handleClick(activeName)">
        ...
        <div class="search">
          <el-form ref="auditFormb" :model="auditFormb" :rules="rules" label-width="140px">
            <el-row :gutter="20">
              ...
              <el-col :span="8">
                <el-form-item label="机构类别" prop="ficp">
                  <el-select v-model="auditFormb.ficp" placeholder="请选择" clearable>
                    <el-option
                      v-for="item in jigou"
                      :key="item.codeKey"
                      :label="item.codeValue"
      ...
      <el-tab-pane label="已备案" name="2">
        <div class="search">
          <el-form ref="auditFormc" :model="auditFormc" :rules="rules" label-width="140px">
            <el-row :gutter="20">
              <el-col :span="8">
                <el-form-item label="机构名称" prop="rinm">
                  <el-input v-model="auditFormc.rinm" placeholder="机构名称" clearable maxlength="50" />
                </el-form-item>
              </el-col>
              <el-col v-if="this.$store.getters.roles" :span="8">
                <el-form-item label="注册地区" prop="registerAddr">
                  <el-cascader
                    v-model="auditFormc.registerAddr"
                    :options="registerAddrArr"
                    :props="{ checkStrictly: true }"
                    clearable
                    style="width:100%"
              ...
              <el-col :span="8">
                <el-form-item label="统一社会信用代码" prop="succ">
                  <el-input v-model="auditFormc.succ" placeholder="统一社会信用代码" clearable maxlength="50" />
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="机构类别" prop="ficp">
                  <el-select v-model="auditFormc.ficp" placeholder="请选择" clearable>
                    <el-option
                      v-for="item in jigou"
                      :key="item.codeKey"
                      :label="item.codeValue"
        ...
        <div class="search">
          <el-form ref="auditFormd" :model="auditFormd" :rules="rules" label-width="140px">
            <el-row :gutter="20">
              ...
              <el-col :span="8">
                <el-form-item label="机构类别" prop="ficp">
                  <el-select v-model="auditFormd.ficp" placeholder="请选择" clearable>
                    <el-option
                      v-for="item in jigou"
                      :key="item.codeKey"
                      :label="item.codeValue"
      ...
      switch (this.activeName) {
        ...
        case '2':
          if (this.tableDatac.length > 0) {
            location.href = `nifaReport/regist/orgInfoOutExcel?userName=${this.$store.getters.userName}&rinm=${this.paramsOldC.rinm}&srnm=${this.paramsOldC.srnm}&ficp=${this.paramsOldC.ficp}&succ=${this.paramsOldC.succ}&currentState=${this.paramsOldC.currentState}&startDate=${this.paramsOldC.startDate === undefined ? '' : this.paramsOldC.startDate}&endDate=${this.paramsOldC.endDate === undefined ? '' : this.paramsOldC.endDate}&registerProvince=${this.paramsOldC.registerProvince}&registerCity=${this.paramsOldC.registerCity}&registerArea=${this.paramsOldC.registerArea}`
          } else {
            this.$message.error('待导出数据为空')
          }
          break
